...
namespace Drawing
{
    ...
    public sealed partial class DrawingPad : Page
    {
        ...
        private void Grid_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            if (mySquare is IDraw) // if your object square is a type of ID draw it will implement 
            {
                IDraw drawSquare = mySquare; // istantiates a new object of IDraw 
                drawSquare.SetLocation((int)mouseLocation.X, (int)mouseLocation.Y); // sets location 
